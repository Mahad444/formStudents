...
if(isset($_POST['save'])){
    ...
    if(empty($_POST['password'])){
        ...
        if(preg_match('/^[a-zA-Z\s]+$/',$password)){
            $errors['password']='password must not be letters and spaces only';
        }
    }
    ...
    if(array_filter($errors)){
        ...
        /*$statement = $databaseConnection ->prepare(
            ...
            try
            {
                $query = "INSERT INTO signup(email, mypassword) VALUES (:email,:myassword)";
